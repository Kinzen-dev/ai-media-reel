...
- TWO FUEL POOLS now: `wtgdshms0.output` (49 bold/wow) + `_backlog-markets-round4.json` (71 market). Alternate between them so batches stay varied (a couple bold-art + a couple market-vertical + a generative + a platform each batch).
