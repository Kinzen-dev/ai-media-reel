...
- Batch 29 IN FLIGHT (wxcgs9j2i): mid-century-saul-bass, interactive-cv-print-replica, biotech-investor-brief, voronoi-skin-layout, native-carousel-filmstrip (5-axis spread). WATCH: voronoi mobile fallback + native-carousel ::scroll-marker support (has a plain-snap fallback).
