...
- Batch 31 IN FLIGHT (wji4ih1lf): art-deco-luxe, ticket-stub-pass, music-release-hub, neo-print-halftone-type, scroll-trigger-manifesto (5-axis spread). WATCH: halftone dots must survive thumbnail downscale (coarse); scroll-trigger first panel must be settled (not mid-flight) at scroll=0.
